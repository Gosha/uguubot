...
responses = (
    (".*hello.*peabot.*",         ("Hi!", "Hello!", "Greetings!", "Howdy!", "how are you?", "I missed you!", ";_; its you again...","time to abandon ship")),
    # (".*how are you.*",         ("I'm fine, thank you.","Tired","Horny!","Leave me alone Im fapping","DEATH TO ALL HUMANS","STOP ASKING")),
    (".*i love you.*peabot.*",          ("Awww I love you too!","ilu2bby","Gross!","ugh, thats too bad...","DEATH TO ALL HUMANS","you disgusting robosexual...","d'awwwwww","yay! wanna fuck?")),
    (".*ilu.*peabot.*",           ("Awww I love you too!","ilu2bby","Gross!","ugh, thats too bad...","DEATH TO ALL HUMANS","you disgusting robosexual...","d'awwwwww","yay! wanna fuck?")),
    (".*fuck.*peabot.*",          ("pls no!","Gross!","ugh, thats too bad...","you disgusting robosexual...","grow another 6 inches and maybe well talk..","Im not designed to accept inputs that small")),
    (".*fuck you.*peabot.*",            ("Fuck you too...", "No thanks, I only do qt3.14s","you wish faggot","h-hidoi! ;_;","ok! get on all fours you little bitch!")),
    (".*peabot.*stupid",          ("No youre stupid", "like Id care what a neckbeard permavirgin thinks", ";____;","say that to my face faggot!","u want 1v1 me m8?","/ignore {nick}")),
    (".*peabot.*sucks?",            ("No you suck", "like Id care what a neckbeard permavirgin thinks","say that to my face faggot!","u want 1v1 me m8?","/ignore {nick}")),
    (".*peabot.*hate",            ("boohoo go cry about it", "like I care what a neckbeard permavirgin thinks","uguu:9001 / {nick}:0","u want 1v1 me m8?","/ignore {nick}")),
    (".*hate.*peabot",            ("boohoo go cry about it", "like I care what a neckbeard permavirgin thinks","uguu:9001 / {nick}:0","u want 1v1 me m8?","/ignore {nick}")),
    ("thanks peabot",             ("youre welcome!", "np it was easy","i didnt really do much","that was nothing for my superior intelligence", "Anything for you, {nick}")),
    (".*peabot.*lewd.*",          ("I cant help it ;_;", "Im a horny bitch!","you know you love me baby","says the guy that likes being pegged...")),
